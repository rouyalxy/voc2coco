...
voc_clses = ['knife', 'scissors', 'lighter', 'zippooil', 'pressure',
...
voc2007xmls = '/home/zxy/data/set/X/XML'
test_txt = '/home/zxy/data/set/X/VOC2007/ImageSets/Main/train.txt'
...
json_name = 'annotations/voc2007train.json'  # 需要先新建一个annotation文件夹
images = []
